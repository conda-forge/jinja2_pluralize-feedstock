...
<table><tr>
    ...
    <td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6684&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jinja2_pluralize-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jinja2_pluralize` can be installed with:

```
conda install jinja2_pluralize
```

It is possible to list all of the versions of `jinja2_pluralize` available on your platform with:
